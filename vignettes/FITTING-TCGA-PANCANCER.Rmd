...
```{r}
copynumber_TCGA <- read.csv(file = system.file("extdata", "Davoli_Charm_score.csv", package = "CancerSimulator"))
copynumber_TCGA <- copynumber_TCGA[, c(1, 2, 3, 14, 15)]
colnames(copynumber_TCGA) <- c("Arm", "Del_freq_all", "Amp_freq_all", "Charm.TSG.OG.score", "Charm.TSG.OG.Ess.score")
```

#   Fitting the TCGA copy number data with CancerSimulator
...
fitting_bulk_arm_CN(
    ...
    model_variables = model_variables,
    copynumber_DATA = copynumber_TCGA,
