...
function SIMULATOR_FULL_PHASE_1_CN_cnloh_terminal(genotype_to_react,genotype_daughter)
    ...
    global prob_CN_cnloh_terminal_length
...
%------------------------------------------------Output the new genotype
    ...
    evolution_genotype_changes{genotype_daughter}{end+1}    = {'cnloh-terminal',chrom,strand_give,strand_take,block_start,block_end};
end
