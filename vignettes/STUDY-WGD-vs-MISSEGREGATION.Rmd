...
T_0 <- list(0, "day")
T_end <- list(300, "day")
Table_sample <- data.frame(Sample_ID = c("SA"), Cell_count = c(100), Age_sample = c(T_end[[1]]))
...
#     stage_final = 3, compute_parallel = TRUE,
...
```{r}
simulation_statistics_multivar(
    model_prefix = model_prefix, folder_workplace = folder_workplace,
    var1_name = var1_name, var1_vals = var1_vals[c(10,10,1,1)],
    var2_name = var2_name, var2_vals = var2_vals[c(10,1,10,1)],
    n_simulations = n_simulations_per_batch,
    compute_parallel = TRUE,
    example_simulation = TRUE
)
```
