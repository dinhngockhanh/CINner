...
```{r}
cn_ov2295 <- read.csv(file = "/Users/dinhngockhanh/Library/CloudStorage/GoogleDrive-knd2127@columbia.edu/My Drive/RESEARCH AND EVERYTHING/Projects/ST-Cod.Single-cell DNA sequencing/DATA_ov2295/ov2295_cell_cn.csv")
```
...
```{r}
cn_arm_sel_3a <- cn_arm_sel_1a
cn_arm_sel_3a$state[which(cn_arm_sel_3a$chr == 3)] <- cn_arm_sel_3a$state[which(cn_arm_sel_3a$chr == 3)] + 1
jpeg(file = "cn_arm_sel_4a.jpeg", width = 300, height = 80)
p <- plotHeatmap(cn_arm_sel_3a,
    plotcol = "state", plottree = FALSE, clusters = data.frame(cell_id = "Cell", clone_id = "A"),
    show_legend = FALSE, show_library_label = FALSE, show_clone_label = FALSE, annofontsize = 20, maxCNcol = 5
)
...
```{r}
cn_arm_sel_3b <- cn_arm_sel_1a
cn_arm_sel_3b$state[which(cn_arm_sel_3b$chr == 3)] <- cn_arm_sel_3b$state[which(cn_arm_sel_3b$chr == 3)] - 1
jpeg(file = "cn_arm_sel_4b.jpeg", width = 300, height = 80)
p <- plotHeatmap(cn_arm_sel_3b,
    plotcol = "state", plottree = FALSE, clusters = data.frame(cell_id = "Cell", clone_id = "A"),
    show_legend = FALSE, show_library_label = FALSE, show_clone_label = FALSE, annofontsize = 20, maxCNcol = 5
)
