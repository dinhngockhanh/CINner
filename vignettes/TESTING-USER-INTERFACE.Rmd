...
# Table_sample <- data.frame(Sample_ID=c('SA01','SA02','SA03'),Cell_count=c(10,10,10),Age_sample=c(40,60,80))

Table_sample <- data.frame(Sample_ID=c('SA01','SA02','SA03'),Cell_count=c(100),Age_sample=c(80))
