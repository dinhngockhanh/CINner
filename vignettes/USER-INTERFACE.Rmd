...
Let's start with having 10 cells with normal female diploid genotype. There would be two strands of each chromosome (strand `A` and strand `B`) from chromosome 1 to X, and no chromosome Y. There is no drivers.
