...
vec_arm_s[which(vec_id=='5p')]  <- 1+0.2
vec_arm_s[which(vec_id=='5q')]  <- 1-0.2
...
```{r}
plot_gainloss(copynumber_CancerSimulator,copynumber_PCAWG)
```
...
plot_phylo_stats(copynumber_CancerSimulator,phylo_stats_data)
```
