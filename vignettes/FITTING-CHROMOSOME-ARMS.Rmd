...
model_variables$general_variables$Value[which(model_variables$general_variables$Variable == "formula_CN_missegregation")] <-
    paste0("prob_CN_missegregation * DNA_length / ", DNA_length_original, " * ")
...
list_parameters_cancer_type_library[nrow(list_parameters_cancer_type_library) + 1, ] <- c("formula_CN_slope", "CNA_formula_appendix", 0, 3)
```
...
# PCAWG_cancer_type_sample_ids
# copynumber_DATA_cancer_types
# PCAWG_wgd
```
