...
#--------------------------------------------Plot heatmap of CN profiles
    if (plotcol=='total_copy'){
        plotHeatmap(sample_genotype_profiles,plotcol="state",clusters=phylogeny_clustering_truth$clustering,tree=phylogeny_clustering_truth$tree,reorderclusters=FALSE,plottree=TRUE)
    }else{if (plotcol=='min_copy'){
        plotHeatmap(sample_genotype_profiles,plotcol="Min",clusters=phylogeny_clustering_truth$clustering,tree=phylogeny_clustering_truth$tree,reorderclusters=FALSE,plottree=TRUE)
    }}
}
