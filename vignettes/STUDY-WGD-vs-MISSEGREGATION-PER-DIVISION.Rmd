...
First, we set up the fixed parameters for the simulation.
Note that we use the per division model for chromosome miseggregation. 
...
We set up parameter sweeps of the probability of chromosome missegregation and probability of whole-genome duplication.
...
We set possible values for the probability of whole-genome duplication to be from 10^{-3}, 2x10^{-3},..., 9x10^{-3}, 10^{-2}.
...
The statistics we consider are clone count, shannon diversity index, clonal missegregation count, subclonal missegregation count, age of most recent common ancestor, and distribution of ploidy.
...
Here we can see how the statistics change by keeping the probability of whole genome duplication constant for all values of probability of chromosomal missegregation.
...
We can see how the statistics change by keeping the probability of chromosomal missegregation constant for all values of probability of whole-genome duplication.
