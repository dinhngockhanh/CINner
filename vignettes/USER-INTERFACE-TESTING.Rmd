...
T_end                               <- list(80,'year')
            ...
            Table_sample                        <- data.frame(Sample_ID=c('SA01','SA02'),Cell_count=c(10,10),Age_sample=c(40,80))

            # Table_sample                        <- data.frame(Sample_ID=c('SA01'),Cell_count=c(10),Age_sample=c(80))
