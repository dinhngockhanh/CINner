...
The function `BUILD_driver_library` builds the driver library, completed with the location of each driver in the genome (this information comes from crosschecking with the Cancer Gene Census database)

```{r}
BUILD_driver_library(MODEL_VARIABLES=MODEL_VARIABLES,
