...
```{r}
prob_CN_whole_genome_duplication    <- 0.5*3e-4
prob_CN_missegregation              <- 0.5*7e-4
prob_CN_chrom_arm_missegregation    <- 0.5*2e-4
prob_CN_focal_amplification         <- 0.5*7e-4
prob_CN_focal_deletion              <- 0.5*2e-4
prob_CN_cnloh_interstitial          <- 0.5*4e-4
prob_CN_cnloh_terminal              <- 0.5*6e-4
