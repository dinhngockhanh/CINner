...
var2_name <- "delta_selection"
var2_vals <- seq(0.05, 0.5, by = 0.05)
var2_vals <- matrix(c(var2_vals, 2 * var2_vals), nrow = 2, byrow = TRUE)
```
...
simulation_statistics_multivar(
    model_prefix = model_prefix, folder_workplace = folder_workplace,
    var1_name = var1_name, var1_vals = var1_vals[c(1,10,10)],
    var2_name = var2_name, var2_vals = matrix(var2_vals[, c(1,1,5)], nrow = 2),
    n_simulations = n_simulations_per_batch,
    compute_parallel = TRUE,
