...
simulation_statistics_multivar(
    ...
    var2_name = var2_name, var2_vals = rep(var2_vals[1], length(var1_vals)),
    var_labs = var1_labs, name_lab = "Scale of selection rates for losses",
    plot_WGD = FALSE,
    n_simulations = n_simulations_per_batch,
    plotname = paste0(model_prefix, "_scale_selection_loss"),
...
simulation_statistics_multivar(
    model_prefix = model_prefix, folder_workplace = folder_workplace,
    var1_name = var1_name, var1_vals = rep(var1_vals[1], length(var2_vals)),
    var2_name = var2_name, var2_vals = var2_vals,
    var_labs = var1_labs, name_lab = "Scale of selection rates for gains",
    plot_WGD = FALSE,
    n_simulations = n_simulations_per_batch,
    plotname = paste0(model_prefix, "_scale_selection_gain"),
    example_simulation = FALSE
)
```
