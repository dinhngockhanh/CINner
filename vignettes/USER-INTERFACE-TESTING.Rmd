...
CN_bin_length                       <- 500000
            prob_CN_whole_genome_duplication    <- 5e-5
            prob_CN_missegregation              <- 7e-5
            prob_CN_chrom_arm_missegregation    <- 7e-5
            prob_CN_focal_amplification         <- 7e-5
            prob_CN_focal_deletion              <- 7e-5
            prob_CN_cnloh_interstitial          <- 7e-5
            prob_CN_cnloh_terminal              <- 7e-5
