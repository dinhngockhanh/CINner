...
PLOT_copy_number_heatmap(package_simulation,phylo='true',plotcol="state",reorderclusters=TRUE,plottree=TRUE)

PLOT_copy_number_heatmap(package_simulation,phylo='true',plotcol="Min",reorderclusters=TRUE,plottree=TRUE)
```
