...
append_with_hmm(model = model_name,n_simulations = n_simulations, UMAP = TRUE)
...
Table_sample <- data.frame(Sample_ID=c('SA01'),Cell_count=c(2),Age_sample=c(80))
