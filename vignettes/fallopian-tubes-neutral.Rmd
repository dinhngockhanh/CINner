...
## Background
This vignette illustrates how to use the program to create simulations for a model.
...
The focal amplification/deletion and interstitial/terminal CN-LOH events require additional parameters for the mean length of each event:
...
The true phylogeny and clustering of the sampled cells are stored in entry 3 of the output package.
...
We can plot the total CN profiles, as well as the minor CN profiles.
