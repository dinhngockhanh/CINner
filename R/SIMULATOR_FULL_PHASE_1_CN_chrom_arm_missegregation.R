...
# row append driver_map_1 by driver_map_2
#        driver_map_1                                        <- rbind(driver_map_1,driver_map_2)
# but I don't know how to change some last elements of the 3rd column!
#        driver_map_1(end+1-N_drivers_to_move:end,3)         = ploidy_chrom_1(chrom);
# so I suppose to change the pos_drivers_to_move rows of 3rd column of driver_map_2 by ploidy_crom1(chrom) first and then row append to driver_map_1
        driver_map_2[pos_drivers_to_move,3]                 <- ploidy_chrom_1[chrom]
        driver_map_1                                        <- rbind(driver_map_1,driver_map_2)
        driver_map_2                                        <- driver_map_2[-pos_drivers_to_move,] # remove some rows
        }
...
#        driver_map_1(pos_drivers_to_move,:)                 = [];
        ...
        driver_map_1[pos_drivers_to_move,3]                 <- ploidy_chrom_2[chrom]
        driver_map_2                                        <- rbind(driver_map_2,driver_map_1)
