...
#       Case 1: all genotypes are different
    ...
    else { if ((flag_mother_daughter1==0)&&(flag_mother_daughter2==1)&&(flag_daughter1_daughter2==0)) {
#       Case 2: combine genotype 2 into mother genotype
    ...
    else { if ((flag_mother_daughter1==1)&&(flag_mother_daughter2==0)&&(flag_daughter1_daughter2==0)) {
#       Case 3: combine genotype 1 into mother genotype
    ...
    else { if ((flag_mother_daughter1==0)&&(flag_mother_daughter2==0)&&(flag_daughter1_daughter2==1)) {
