...
```{r}
#---ov2295_cell_cn.csv: downloaded from https://zenodo.org/record/3445364#.Ytq9ji-B3Pw
ov2295_cn       <- read.csv(file = 'test_cell_cn.csv')
# ov2295_cn       <- read.csv(file = 'ov2295_cell_cn.csv')
gc              <- read.csv(file = system.file("extdata", "gc_map_500kb.csv", package = "CancerSimulator"))

analysis_dlp_cn(CNbins = ov2295_cn, gc = gc)
