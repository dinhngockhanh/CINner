...
model_prefix <- "WGD-vs-MISSEGREGATION-PER-HOMOLOG"
folder_workplace <- "WGD-vs-MISSEGREGATION-PER-HOMOLOG"
```


```{r}
# model_variables_base$general_variables$Value[which(model_variables_base$general_variables$Variable == "prob_CN_whole_genome_duplication")] <- 1e-2
...
# model_variables_base$general_variables$Value[which(model_variables_base$general_variables$Variable == "prob_CN_missegregation")] <- 1e-2/46
...
n_simulations_per_batch <- 30

var1_name <- "prob_CN_missegregation"
var1_vals <- seq(1e-3, 1e-2, by = 1e-3)/46
var1_labs <- scientific(seq(1e-3, 1e-2, by = 1e-3))
