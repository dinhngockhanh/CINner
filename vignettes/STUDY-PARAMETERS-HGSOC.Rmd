...
copynumber_CancerSimulator <- parLapply(cl, 1:n_simulations, function(iteration) {
    ...
    # simulation_lite$cn_profiles_long<-simulation$sample$cn_profiles_long
...
stopCluster(cl)
# copynumber_CancerSimulator  <- list()
# for (i in 1:n_simulations){
#     copynumber_CancerSimulator[[i]] <- read.csv(file = paste(model_name, "_cn_profiles_long_", i, ".csv", sep = ""))
# }
```
