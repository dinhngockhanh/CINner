...
p <- ggplot(data = df_all, aes(x = t, y = value)) +
    ...
    theme(panel.background = element_rect(fill = "white", colour = "grey50"), text = element_text(size = 40), legend.position = "top", legend.justification = "left", legend.direction = "horizontal", legend.key.width = unit(2.5, "cm"), axis.text.y = element_blank(), axis.ticks.y = element_blank()) +
