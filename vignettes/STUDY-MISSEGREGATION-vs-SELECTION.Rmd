...
########################################################################
########################################################################
prob_CN_whole_genome_duplication <- 1e-2
...
# var1_vals <- seq(1e-4,1e-3,by=1e-4)
# var2_name <- "delta_selection"
# var2_vals <- seq(0.01,0.1,by=0.01)





#--------------------------------------------MISSEGREGATION vs SELECTION
n_simulations_per_batch <- 9
